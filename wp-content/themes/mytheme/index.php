...
<head>
    ...
    <link href='<?php echo get_template_directory_uri(); ?>/http://fonts.googleapis.com/css?family=Asap:400,700' rel='stylesheet' type='text/css'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box-item">
							<img src="<?php echo get_template_directory_uri(); ?>/images/8.jpg" class="img-responsive"/>
							<div class="content">
